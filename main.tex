...
I, personally, don't think they are ``generative artificial intelligences,'' because although they are generative (they generate new things), they show no signs of intelligence.
...
For this very \documentname, I used LLMs to learn some details about \textsl{BibTeX} formatting, and also get a summary of some ideas in animal rights (see above) and post-structuralist literary criticism (see below).
...
For example, when I used the LLM (\textsl{Claude} in this case) to learn about post-structuralism, I asked about strains of thought in literary criticism.
...
Once that worked, I worked through the Wikipedia page \cite{poststructuralism}, which is absolutely excellent.

\emph{Trust} was a critical idea among the points of agreement,
...
The \textsl{astropy} codebase can't take responsibility, but the specific authors of the code, and in particular the authors of the coordinates package, definitely \emph{can} take responsibility, and \emph{do} take responsibility.
...
Ultimately, I think the real question we face is not the question of \emph{how} we do astrophysics.
