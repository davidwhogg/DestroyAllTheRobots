...
HOGG: GREG asks: What would an LLM have to do to earn your trust? Is it even possible for something that has no accountability, cannot take responsability or suffer consequences (career setbacks, humiliation) to be trustworthy? How is an LLM different from a corporation?
...
HOGG: Andy says: \textsl{For your final paragraph I think you should end on “why did I write this white paper”, which might include something about how there is a very diverse set of perspectives on LLMs in astronomy (just even within your circle). People have very strong and disparate views, and ultimately they are probably arguing about the wrong question of HOW we do astronomy when they should be asking WHY do we do astronomy.} I agree with that!
