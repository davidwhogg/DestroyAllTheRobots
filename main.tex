...
% - emails from Graur, Lintott, Zuckerman, Rincon, Hackett, and others on 2026-02-12.
% - in particular, Hackett argues that my summary of what LLMs do (or are) is incorrect.
% - Ginsburg email conversation starting on 2026-02-12; the idea that astro might have to move to a more in-person mode.
% - Buchner email 2026-02-15 makes some suggested edits.
% - Roger Romani point at Stanford talk that it teaches us how to talk to aliens! (Possibly inspired by Hail Mary).
% - Daniel Harlow point at MIT talk that the Global Circulation Model and climate chnage might be a clinical value of astrophysics!
% - Slozar point that only one kind of reproducibility is actually harmed by LLMs. See email from 2026-05-22-ish.
...
The author is at the Center for Cosmology and Particle Physics, Department of Physics, New York University; and at the Center for Computational Astrophysics, Flatiron Institute; and at the Max-Planck-Institut f\"ur Astronomie, Heidelberg;
send email to $\langle$david.hogg@nyu.edu$\rangle$.
...
An LLM cannot be an author is because it \emph{cannot sign a copyright or licensing agreement}.
