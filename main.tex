...
for discussions that informed the ideas presented here, and 
  ...
  Phil Marshall (SLAC),
  Kate Storey-Fisher (Stanford), and
  Soledad Villar (JHU)
...
HOGG SAY: Is this the place to note that 'Claude' is not the author of anything?
That is, it isn't really correct, if you use an LLM, to give that LLM co-authorship on your paper, any more than it is to give astropy or copilot or the Mac operating system coauthorship.
...
HOGG ASKS: Do I add this as a new point-of-agreement?\footnote{%
This point has been made strongly to me many times by Mike Blanton (Carnegie), who gives a lot of credit to \cite{oppy}.}
...
But note how this is related to the point above that we don't do astrophysics to \emph{find out the answers}:
...
This point was made very strongly to me by Natalie B. Hogg in HOGG CITE BLOGPOST.
...
The ban-and-punish policy also isn't consistent with our obligations to our funding sources and our public.
