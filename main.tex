...
% - PJM point about hope (and is the public love of astronomy a clinical value? I don't think so?). See email 2025-12-31.
...
Before I answer the question in the title, I want to highlight one reason \emph{we don't do astrophysics}.
...
But this point---that we don't care about the specific results---is obvious, in the following way:
...
Jim Simons is responsible for a lot of results in physics and astronomy, more than any astrophysicist, and he did it by running an extremely successful (and tax-avoidant) hedge fund in the US \cite{simons}.
...
I opened by asking how astrophysics should react to the imminent creation of language models that can competently design, execute, analyze, write up, referee, and publish astrophysics projects.

HOGG:
On the one hand, if LLMs get excellent at doing data science, should we just sit back and let them cook?
We can read the results as they come in.
That's efficient, and (maybe) rigorous. It also serves some of the public-interest aspects of the subject.
