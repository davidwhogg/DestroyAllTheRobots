...
\renewcommand\thebibliography[1]{
  \OLDthebibliography{#1}\setlength{\parskip}{0pt}\setlength{\itemsep}{3pt plus 0.3ex}\footnotesize
}
...
One possible extreme policy proposal is that we \emph{fully embrace} the LLMs, and encourage them (or even give them enormous resources).
