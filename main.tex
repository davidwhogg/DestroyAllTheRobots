...
It must be that the clinical value is the its feeding of humanity's love.\footnote{%
...
However, large projects on mountains in the US (including Hawai`i), China, and Chile all represented development opportunities that contributed to economies (and often upset local populations).
...
Dear reader, you probably either think this policy is disastrously wrong, or obviously right.
...
Under this policy, nothing fundamental about the practice of astrophysics would different from what it was in 2019, say, with the exception that web searches for code issues, and code development environments, might be a bit better (or at least different).
...
\paragraphskip
PEOPLE: If you have read this far, you have read everything I have been able to coherently write.
