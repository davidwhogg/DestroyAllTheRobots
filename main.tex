...
The author thanks
  ...
  and
  Kate Storey-Fisher (Stanford) for discussions that informed this \documentname.
...
If a science \emph{does} have clinical value, I still think this is true, but I would be willing to be debated on it.
You might notice that I am not a \emph{utilitarian}, but I am willing to listen to utilitarian arguments.
...
It used to be (when I was a PhD student) that every published scientific paper had a printed copy, on acid-free paper, in almost every academic library in the world (literally thousands of copies, well tended).
...
The second comment is that I often hear software (and hardware and engineering-oriented) people say that they ``have to'' write papers because papers---and the citations that they generate---are ``the coin of the realm.''
Papers (and authorships on papers) and citations are not ``coin'' of anything!
...
Many astronomers have spent many years measuring it, and we know it very precisely \cite{age}.
...
No astronomer (that I know) is improving the calibration of \textsl{JWST} instruments because they want the US Navy to have a higher kill rate.

\section{Some comments about how astrophysics works}
